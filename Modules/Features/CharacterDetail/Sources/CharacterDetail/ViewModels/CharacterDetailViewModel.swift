...
//
//        if let service = favoritesService {
//            Task.detached { [safeCharacterId, safeCharacterName, weak self] in
//                do {
//                    if currentValue {
//                        // Pega a URL da imagem do character atual
//                        let imageURL = await MainActor.run {
//                            self?.detailModel.character.image.bestQualityUrl
//                        }
//
//                        let input = FavoriteCharacterInput(
//                            id: safeCharacterId,
...
//                        }
//                    } else {
//                        try await service.removeFavorite(characterId: safeCharacterId)
//                        await MainActor.run {
//                            characterDetailDebugPrint("✅ Removed from favorites")
//                        }
//                    }
...
//
//        // Fallback local (UserDefaults)
//        Task.detached { [safeCharacterId, currentValue] in
//            var favorites = UserDefaults.standard.array(forKey: "FavoriteCharacters") as? [Int] ?? []
//            if currentValue {
