...
//
//                // Garante que imagens e tabelas se ajustem à largura
...
//            }
//
//            /* Hero image: figura logo após título ocupa largura inteira
//               (ex: capa em "Creation"). */
//            h1 + figure,
//            h2 + figure,
//            h3 + figure {
...
//            }
//
//            /* Figuras "de lado": sempre à ESQUERDA para o texto fluir à direita. */
...
//        }
//
//        // Limita a quantidade de <img>, se maxImages < Int.max
...
//                    var mutable = ns
//                    // Remoção de trás pra frente pra não bagunçar os ranges
