...
// MARK: - Preview
#if DEBUG
#Preview("FullScreenLoadingComponent - Default") {
    FullScreenLoadingComponent()
}

#Preview("FullScreenLoadingComponent - Custom Text") {
    FullScreenLoadingComponent(loadingText: "Processing")
}

#Preview("FullScreenLoadingComponent - With Back Button") {
    FullScreenLoadingComponent(
        loadingText: "Loading",
